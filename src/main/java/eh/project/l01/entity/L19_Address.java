...
@Entity
@Table(name = "L19_ADDRESS")
public class L19_Address {
	...
	private L19_Student student;
	
	public L19_Address() {

	}

	public L19_Address(String addressStreet, int addressStreetNumber, String addressDistrict, String addressCity,int addressPostCode) {
	...
	public L19_Student getStudent() {
		return student;
	}

	public void setStudent(L19_Student student) {
